...
class AIpptGenerator:
    ...
    def create_presentation(self, slides: List[SlideContent], template: str = "modern") -> Presentation:
        """
        創建 PowerPoint 簡報
    ...
    def _add_title_slide(self, content: SlideContent):
        ...
        # 設定副標題
        if slide.placeholders[1] and content.content:
...
def main():
    ...
    try:
        ...
        if output_choice in ["1", "3"]:
            # 創建並儲存簡報
            presentation = generator.create_presentation(slides)
