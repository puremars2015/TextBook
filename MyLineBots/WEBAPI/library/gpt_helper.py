...
from WEBAPI.library.sqlite_helper import SQLiteHelper
...
api_key = config.section['OPEN_AI']
...
class MyGPT:
    ...
    def FetchDataByGPT(self, msg) -> str:
            ...
            input=[
                {
                    ...
                    "content": [
                        {
                        "type": "input_text",
                        "text": "你是一個資料擷取機,依據提示擷取資料,並將資料以JSON格式回傳"
                        }
                    ]
                },
                {
